...
godot_variant ext_fmod_sound_load(godot_object* p_instance, void* p_method_data, void* p_user_data, int p_num_args, godot_variant** p_args)
{
	...
	FMOD_RESULT result = FMOD_System_CreateSound(fmod_system, api->godot_char_string_get_data(&path), FMOD_CREATESTREAM | FMOD_OPENONLY | FMOD_IGNORETAGS | FMOD_LOWMEM, NULL, &sound_dat->sound);
